...
class PageFieldControllerSpec extends Specification {
    ...
    def "adjustFieldOrder"() {
        ...
        def entity = restTemplate.exchange(url + "/adjust_order?pageCode=" + testPageCode, HttpMethod.POST, httpEntity, PageFieldDTO.class, organizationId)
    ...
    def "update"() {
        ...
        def entity = restTemplate.exchange(url + '/{field_id}?pageCode=' + testPageCode, HttpMethod.PUT, httpEntity, PageFieldDTO.class, organizationId, list[2].fieldId)
